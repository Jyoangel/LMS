...
//         // Validate 'present' to be a boolean
...
//         // Log the current state of the cache before update
//         console.log(`Cache before update:`, attendanceCache);

//         // Update the in-memory cache only if 'present' is true
//         if (present) {
//             if (!attendanceCache[studentId]) {
//                 attendanceCache[studentId] = [];
//             }
//             // Add date if it's not already in the cache
//             if (!attendanceCache[studentId].includes(dateString)) {
//                 attendanceCache[studentId].push(dateString);
//                 console.log(`Added ${dateString} to cache for student ${studentId}`);
//             }
//         } else {
//             // Remove date from the cache if present is false
//             if (attendanceCache[studentId]) {
//                 attendanceCache[studentId] = attendanceCache[studentId].filter(date => date !== dateString);
//                 console.log(`Removed ${dateString} from cache for student ${studentId}`);
//             }
//         }

//         // Log the updated state of the cache
//         console.log(`Cache after update:`, attendanceCache);
