...
export default function CommunicationTable({ filter, searchTerm, setSelectedStudent }) {
  ...
  const handleSelectStudent = async (studentID, isChecked) => {
    try {
      const updatedData = await selectStudent(studentID, isChecked); // Update selected status to isChecked (true/false) for the student
      // Optionally handle response if needed
      setSelectedStudent(studentID); // Update selected student in parent component state
      loadItems(); // Reload the data after update to reflect changes
    } catch (error) {
