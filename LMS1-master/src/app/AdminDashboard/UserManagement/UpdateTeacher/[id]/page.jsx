...
import { fetchTeacherById, updateTeacherData } from '../../../../../../api/teacherapi';
...
const UpdateTeacher = ({ params }) => {
    ...
    return (
        <div className="h-screen w-full flex flex-col px-5 py-10 gap-10">
            ...
            {/* Success Modal */}
            {isSelectOpen && (
                <Successcard onClose={closeModal} message="Teacher updated successfully!" url={"/AdminDashboard/UserManagement"} />
            )}
        </div>
    );
};
