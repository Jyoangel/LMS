...
import { fetchFeeRecordByMonth, updateFeeRecordByMonth } from "../../../../../../../../../api/api"; // Assuming you have these API functions
...
export default function EditFeeMonth({ params }) {
    ...
    return (
        <>
            ...
            {isSelectOpen && (
                <Successcard onClose={closeModal} para={"Fees updated successfully!"} />
            )}
        </>
    );
}
