...
import { fetchAttendanceByStudentId } from "../../../../api/attendanceapi"; // Update with the correct path
import { updateAttendanceByStudentId } from "../../../../api/attendanceapi"; // Import the update function
...
const AttendanceCalendar = () => {
  ...
  useEffect(() => {
    // Fetch attendance data for the studentId
