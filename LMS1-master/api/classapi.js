...
export async function fetchClassData() {
    const res = await fetch('http://localhost:5000/api/class/get');
...
export async function addClassData(classData) {
    const res = await fetch('http://localhost:5000/api/class/add', {
        method: 'POST',
        headers: {
...
export async function fetchClassById(id) {
    const res = await fetch(`http://localhost:5000/api/class/get/${id}`);
...
export const updateClassData = async (id, formData) => {
    try {
        ...
        const response = await fetch(`http://localhost:5000/api/class/update/${id}`, {
...
export async function deleteClassData(id) {
    const url = `http://localhost:5000/api/class/delete/${id}`;
