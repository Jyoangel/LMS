...
export async function fetchCalendarData() {
    const res = await fetch('http://localhost:5000/api/calendar/get');
...
export async function fetchCalendarById(id) {
    const res = await fetch(`http://localhost:5000/api/calendar/get/${id}`);
...
export const updateCalendarData = async (id, formData) => {
    try {
        ...
        const response = await fetch(`http://localhost:5000/api/calendar/update/${id}`, {
...
export async function deleteCalendarData(id) {
    const url = `http://localhost:5000/api/calendar/delete/${id}`;
